...
/**
 * @file tfSurfaceAreaConstraint.h
 * 
 */
...
namespace TissueForge::models::vertex { 
    ...
    /**
     * @brief Imposes a surface area constraint on @ref Body or @ref Surface instances. 
     * 
     ...
     * @f$ A @f$ is the area an object and 
     * @f$ A_o @f$ is a target area. 
     */
