...
namespace TissueForge::rendering {
    ...
    struct WidgetRenderer : SubRenderer {
        ...
        HRESULT setFontSize(const float size);
        HRESULT setTextColor(Magnum::Ui::Type type, Magnum::Ui::Style style, Magnum::Ui::State state, const Magnum::Color4& color);
        HRESULT setBackgroundColor(Magnum::Ui::Type type, Magnum::Ui::Style style, Magnum::Ui::State state, const Magnum::Color4& color);
        ...
        TissueForge::FVector4 getTextColor() const;
        TissueForge::FVector4 getBackgroundColor() const;

        private:

        float fontSize;
        TissueForge::FVector4 textColor; // RGBA
        TissueForge::FVector4 backgroundColor; // RGBA
    };
}
