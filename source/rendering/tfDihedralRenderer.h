...
#ifndef _SOURCE_RENDERING_TFDIHEDRALRENDERER_H_
#define _SOURCE_RENDERING_TFDIHEDRALRENDERER_H_
...
namespace TissueForge::rendering {
    ...
    struct DihedralRenderer : SubRenderer {
...
#endif // _SOURCE_RENDERING_TFDIHEDRALRENDERER_H_