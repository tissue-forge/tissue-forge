...
#ifndef _SOURCE_RENDERING_TFBONDRENDERER_H_
#define _SOURCE_RENDERING_TFBONDRENDERER_H_
...
namespace TissueForge::rendering {
    ...
    struct BondRenderer : SubRenderer {
...
#endif // _SOURCE_RENDERING_TFBONDRENDERER_H_