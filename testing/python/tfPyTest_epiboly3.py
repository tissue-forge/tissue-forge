...
p_yolk = tf.Potential.glj(e=35, m=6, k=10, max=10)
...
tf.init(dim=dim, cutoff=5, dt=0.001, windowless=True)
...
cell_positions = [p * ((1 + dr/2) * Yolk.radius) + yolk.position for p in tf.random_points(tf.PointsType.SolidSphere.value,
                                                                                           6000,
                                                                                           dr=dr,
